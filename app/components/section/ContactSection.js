...
export default function ContactSection() {
  ...
  return (
    <Section className="flex flex-col gap-12 bg-[var(--bg-light)]">
      ...
      <div ref={sectionRef} className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto w-full">
        ...
        <div ref={rightRef}>
          <form
            ...
            className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(42,27,127,0.1)] p-6 sm:p-8 space-y-4"
          >
            ...
            <textarea
              ...
              className="w-full p-3 border border-gray-200 rounded-xl
                resize-none focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/30
                focus:border-[var(--primary)] transition-all duration-200
                text-[0.95rem] placeholder:text-gray-400"
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl text-white font-semibold
                ...
                ${loading
                  ...
                  : 'bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] hover:opacity-90 hover:-translate-y-0.5 hover:shadow-lg'
                }`}
            >
